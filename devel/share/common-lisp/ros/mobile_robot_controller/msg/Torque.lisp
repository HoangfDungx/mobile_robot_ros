...
(cl:in-package mobile_robot_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Torque>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Torque)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mobile_robot_controller-msg:<Torque> is deprecated: use mobile_robot_controller-msg:Torque instead.")))

(cl:ensure-generic-function 'left_wheel-val :lambda-list '(m))
(cl:defmethod left_wheel-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:left_wheel-val is deprecated.  Use mobile_robot_controller-msg:left_wheel instead.")
  (left_wheel m))

(cl:ensure-generic-function 'right_wheel-val :lambda-list '(m))
(cl:defmethod right_wheel-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:right_wheel-val is deprecated.  Use mobile_robot_controller-msg:right_wheel instead.")
  (right_wheel m))

(cl:ensure-generic-function 'theta1-val :lambda-list '(m))
(cl:defmethod theta1-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:theta1-val is deprecated.  Use mobile_robot_controller-msg:theta1 instead.")
  (theta1 m))

(cl:ensure-generic-function 'theta2-val :lambda-list '(m))
(cl:defmethod theta2-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:theta2-val is deprecated.  Use mobile_robot_controller-msg:theta2 instead.")
  (theta2 m))

(cl:ensure-generic-function 'theta3-val :lambda-list '(m))
(cl:defmethod theta3-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:theta3-val is deprecated.  Use mobile_robot_controller-msg:theta3 instead.")
  (theta3 m))

(cl:ensure-generic-function 'theta4-val :lambda-list '(m))
(cl:defmethod theta4-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robot_controller-msg:theta4-val is deprecated.  Use mobile_robot_controller-msg:theta4 instead.")
  (theta4 m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Torque>)))
  ...
  (cl:format cl:nil "float64 left_wheel~%float64 right_wheel~%float64 theta1~%float64 theta2~%float64 theta3~%float64 theta4~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Torque)))
  "Returns full string definition for message of type 'Torque"
  (cl:format cl:nil "float64 left_wheel~%float64 right_wheel~%float64 theta1~%float64 theta2~%float64 theta3~%float64 theta4~%~%~%"))
